    ...
    def __init__(self):  
        ...
        self.mapper.connect("test","/test/{action}",
                ...
                mykey="myvalue",
                            conditions={"method": ['GET']})
        # as openstack nova 
        #/root/nova-stable-kilo/nova/api/openstack/compute
        # __init__.py and servers.py
        self.serverr= servers.create_resource()
        self.mapper.connect("test22","/test22/{action}",
                controller=self.serverr,
                mykey="myvalue",
                            conditions={"method": ['GET']})
