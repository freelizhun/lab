...
class Daemon(object):
    ...
    def __init__(self, conf, logger_path):
        self.conf = conf
        self.logger = logger_path
...
def run_daemon(klass, conf_file, logger_path, section_name='', once=False, **kwargs):
    """
    ...
    #conf_file = '/root/daemonall/swift.conf'
    #print conf_file
    ...
    try:
        #conf = []
        klass(conf, logger).run(once=once, **kwargs)
