...
def EncryptWithAES(encrypt_cipher, plaintext_data):
    ...
    print 'check padding %d'%len(plaintext_padded)
...
#our_data_to_encrypt = u'123456789012345678901234567890abc'*10
our_data_to_encrypt = u'12345678'*32*1000
print 'original size %d'%len(our_data_to_encrypt)
encrypted_data = EncryptWithAES(cipher_for_encryption, our_data_to_encrypt)
#print ('Encrypted string:', encrypted_data)
print 'size %d'%len(encrypted_data)
...
#print 'size %d'%len(decrypted_data)
